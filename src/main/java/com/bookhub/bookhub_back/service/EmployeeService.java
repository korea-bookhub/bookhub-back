...
public interface EmployeeService {
    ...
    ResponseDto<List<EmployeeSignUpApprovalsReponseDto>> getPendingEmployee();

    ResponseDto<EmployeeResponseDto> getEmployeeById(Long employeeId);

    ResponseDto<EmployeeSignUpApprovalsReponseDto> updateApproval(Long id, @Valid EmployeeSignUpApprovalRequestDto dto, String loginId);
